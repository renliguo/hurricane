 ...
 *   based on the I2CSPM.
 **************************************************************************/
uint32_t Si72xx_Read_Register(gos_i2c_device_t *i2c,
                              uint8_t addr,
                              uint8_t reg,
                              uint8_t *data)
{
  ...
  ret = gos_i2c_transfer(i2c, messages, 2);
 ...
 **************************************************************************/
uint32_t Si72xx_Write_Register(gos_i2c_device_t *i2c,
                               uint8_t addr,
                               uint8_t reg,
                               uint8_t data)
{
  ...
  ret = gos_i2c_transfer(i2c, messages, 1);
 ...
 **************************************************************************/
uint32_t Si72xx_Read_MagField_Data(gos_i2c_device_t *i2c,
                                   uint8_t addr,
                                   int16_t *magData)
{
  uint8_t read = 0;
 ...
 *   The I2C address of the sensor.
 **************************************************************************/
uint32_t Si72xx_FromIdle_GoToSleep(gos_i2c_device_t *i2c, uint8_t addr)
{
  uint32_t result = 0;
  uint8_t read;
 ...
 *   The I2C address of the sensor.
 **************************************************************************/
uint32_t Si72xx_FromIdle_GoToSltimeena(gos_i2c_device_t *i2c, uint8_t addr)
{
  uint8_t read;
  uint32_t result = 0;
 ...
 *   based on the I2CCSPM
 **************************************************************************/
uint32_t Si72xx_WakeUpAndIdle(gos_i2c_device_t *i2c, uint8_t addr)
{
  gos_result_t ret;
  uint8_t i2c_write_data[1];
  gos_i2c_message_t messages[1];
 ...
 *       OTP data read out
 **************************************************************************/
static uint32_t Si72xx_Read_OTP(gos_i2c_device_t *i2c,
                                uint8_t addr,
                                uint8_t otpAddr,
                                uint8_t *otpData)
{
 ...
 *   20mT or 200mT
 **************************************************************************/
static uint32_t Si72xx_Set_mT_Range(gos_i2c_device_t *i2c,
                                    uint8_t addr,
 ...
 **************************************************************************/
uint32_t Si72xx_ReadMagFieldDataAndSleep(gos_i2c_device_t *i2c,
                                         uint8_t addr,
                                         Si72xxFieldScale_t mTScale,
 ...
 **************************************************************************/
uint32_t Si72xx_EnterSleepMode(gos_i2c_device_t *i2c,
                               uint8_t addr,
                               Si72xxSleepMode_t sleepMode)
{
  uint32_t result = 0;
 ...
 *   The I2C address of the sensor
 **************************************************************************/
uint32_t Si72xx_EnterLatchMode(gos_i2c_device_t *i2c, uint8_t addr)
{
  uint8_t read;
  uint32_t result = 0;
 ...
 **************************************************************************/
uint32_t Si72xx_ReadTemperatureAndSleep(gos_i2c_device_t *i2c,
                                        uint8_t addr,
                                        int32_t *rawTemp)
{
  uint32_t result = 0;
 ...
 **************************************************************************/
uint32_t Si72xx_ReadTempCorrectionDataAndSleep(gos_i2c_device_t *i2c,
                                               uint8_t addr,
                                               int16_t *offsetValue,
                                               int16_t *gainValue)
{
 ...
 *****************************************************************************/
uint32_t Si72xx_ReadCorrectedTempAndSleep(gos_i2c_device_t *i2c,
                                          uint8_t addr,
                                          int16_t offsetData,
                                          int16_t gainData,
...
**************************************************************************/
uint32_t Si72xx_IdentifyAndSleep(gos_i2c_device_t *i2c,
                                 uint8_t addr,
                                 uint8_t *partId,
                                 uint8_t *partRev)
{
...
*        Si72xx part Revision
**************************************************************************/
uint32_t Si72xx_ReadVariantAndSleep(gos_i2c_device_t *i2c,
                                    uint8_t addr,
                                    uint8_t *basePn,
                                    uint8_t *pnVariant)
{
