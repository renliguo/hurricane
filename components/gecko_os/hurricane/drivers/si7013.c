 ...
 *   based on the I2CDRV.
 *****************************************************************************/
static int32_t Si7013_Measure(gos_i2c_device_t *i2c_device, uint8_t addr, uint32_t *data,
                              uint8_t command)
{
  gos_result_t ret;
 ...
 *   based on the I2CDRV.
 *****************************************************************************/
static int32_t Si7013_StartNoHoldMeasure(gos_i2c_device_t *i2c_device, uint8_t addr, uint8_t command)
 ...
 *****************************************************************************/
int32_t Si7013_GetFirmwareRevision(gos_i2c_device_t *i2c_device, uint8_t addr, uint8_t *fwRev)
{
 ...
 *   Returns zero on OK, non-zero otherwise.
 *****************************************************************************/
int32_t Si7013_StartNoHoldMeasureRHAndTemp(gos_i2c_device_t *i2c_device, uint8_t addr)
{
 ...
 *   based on the I2CDRV.
 *****************************************************************************/
static int32_t Si7013_ReadNoHoldData(gos_i2c_device_t *i2c_device, uint8_t addr, uint32_t *data)
{
 ...
 *   Returns zero on OK, non-zero otherwise.
 *****************************************************************************/
int32_t Si7013_ReadNoHoldRHAndTemp(gos_i2c_device_t *i2c_device, uint8_t addr, uint32_t *rhData,
                                   int32_t *tData)
{
 ...
 *   Returns zero on OK, non-zero otherwise.
 *****************************************************************************/
int32_t Si7013_MeasureRHAndTemp(gos_i2c_device_t *i2c_device, uint8_t addr, uint32_t *rhData,
                                int32_t *tData)
{
...
/** @cond DO_NOT_INCLUDE_WITH_DOXYGEN */
static int32_t Si7013_WriteUserReg2(gos_i2c_device_t *i2c_device, uint8_t addr, int8_t data)
{
  gos_result_t ret;
 ...
 *   Returns zero on OK, non-zero otherwise.
 *****************************************************************************/
int32_t Si7013_MeasureV(gos_i2c_device_t *i2c_device, uint8_t addr, int32_t *vData)
{
  int ret;
 ...
 *****************************************************************************/
bool Si7013_Detect(gos_i2c_device_t *i2c_device, uint8_t addr, uint8_t *deviceId)
{
