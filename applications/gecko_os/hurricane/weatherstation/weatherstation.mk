...
NAME := hurricane_weatherstation

# The name of the project
PROJECT_NAME := hurricane_weatherstation
...
$(NAME)_REQUIRED_COMPONENTS := components.gecko_os.hurricane resources.gecko_os.webapp components.gecko_os.third_party.graphics.emwin
